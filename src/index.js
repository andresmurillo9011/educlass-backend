...
Exactamente 4 ramas con conceptos reales de "${tema}" y 3 preguntas. Sin texto extra.`,
      ...
      ruleta: `Genera ruleta educativa sobre "${tema}" para ${area} grado ${grado} Colombia. SOLO JSON: {"categorias":[{"nombre":"Facil","color":"#22c55e","preguntas":[{"pregunta":"Pregunta facil","respuesta":"Respuesta"}]},{"nombre":"Medio","color":"#f59e0b","preguntas":[{"pregunta":"Pregunta media","respuesta":"Respuesta"}]},{"nombre":"Dificil","color":"#ef4444","preguntas":[{"pregunta":"Pregunta dificil","respuesta":"Respuesta"}]},{"nombre":"Comodin","color":"#8b5cf6","preguntas":[{"pregunta":"Pregunta especial","respuesta":"Respuesta"}]}]}`,
      memoria: `Genera memoria educativa sobre "${tema}" para ${area} grado ${grado} Colombia. SOLO JSON: {"pares":[{"id":1,"termino":"TERMINO1","definicion":"Def breve 1"},{"id":2,"termino":"TERMINO2","definicion":"Def breve 2"},{"id":3,"termino":"TERMINO3","definicion":"Def breve 3"},{"id":4,"termino":"TERMINO4","definicion":"Def breve 4"},{"id":5,"termino":"TERMINO5","definicion":"Def breve 5"},{"id":6,"termino":"TERMINO6","definicion":"Def breve 6"}]} 6 pares reales sobre el tema.`
