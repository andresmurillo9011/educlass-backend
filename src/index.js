...
app.post("/generar-actividad", authMiddleware, async (req, res) => {
  try {
    ...
    const prompts = {
      ...
      pasapalabra: `Genera Pasapalabra sobre "${tema}" ${area} grado ${grado} Colombia. SOLO JSON sin texto extra: {"letras":[{"letra":"A","pregunta":"Con A: concepto del tema","respuesta":"APALABRA","pista":"pista"},{"letra":"B","pregunta":"Con B: concepto","respuesta":"BPALABRA","pista":"pista"},{"letra":"C","pregunta":"Con C: concepto","respuesta":"CPALABRA","pista":"pista"},{"letra":"D","pregunta":"Con D: concepto","respuesta":"DPALABRA","pista":"pista"},{"letra":"E","pregunta":"Con E: concepto","respuesta":"EPALABRA","pista":"pista"},{"letra":"F","pregunta":"Con F: concepto","respuesta":"FPALABRA","pista":"pista"},{"letra":"G","pregunta":"Con G: concepto","respuesta":"GPALABRA","pista":"pista"},{"letra":"H","pregunta":"Con H: concepto","respuesta":"HPALABRA","pista":"pista"}]}`,
      ruleta: `Genera ruleta sobre "${tema}" ${area} grado ${grado} Colombia. SOLO JSON: {"categorias":[{"nombre":"Facil","color":"#22c55e","preguntas":[{"pregunta":"P1","respuesta":"R1"},{"pregunta":"P2","respuesta":"R2"}]},{"nombre":"Medio","color":"#f59e0b","preguntas":[{"pregunta":"P1","respuesta":"R1"}]},{"nombre":"Dificil","color":"#ef4444","preguntas":[{"pregunta":"P1","respuesta":"R1"}]},{"nombre":"Comodin","color":"#8b5cf6","preguntas":[{"pregunta":"P1","respuesta":"R1"}]}]}`,
      memoria: `Genera memoria sobre "${tema}" ${area} grado ${grado} Colombia. SOLO JSON: {"pares":[{"id":1,"termino":"T1","definicion":"D1"},{"id":2,"termino":"T2","definicion":"D2"},{"id":3,"termino":"T3","definicion":"D3"},{"id":4,"termino":"T4","definicion":"D4"},{"id":5,"termino":"T5","definicion":"D5"},{"id":6,"termino":"T6","definicion":"D6"}]}`,
...
Exactamente 4 ramas con conceptos reales de "${tema}" y 3 preguntas. Sin texto extra.`,
      ...
      pasapalabra: `Genera Pasapalabra sobre "${tema}" ${area} grado ${grado} Colombia. SOLO JSON: {"letras":[{"letra":"A","pregunta":"Con A:","respuesta":"PALABRA","pista":"pista"},{"letra":"B","pregunta":"Con B:","respuesta":"BPALABRA","pista":"pista"},{"letra":"C","pregunta":"Con C:","respuesta":"CPALABRA","pista":"pista"},{"letra":"D","pregunta":"Con D:","respuesta":"DPALABRA","pista":"pista"},{"letra":"E","pregunta":"Con E:","respuesta":"EPALABRA","pista":"pista"},{"letra":"F","pregunta":"Con F:","respuesta":"FPALABRA","pista":"pista"},{"letra":"G","pregunta":"Con G:","respuesta":"GPALABRA","pista":"pista"},{"letra":"H","pregunta":"Con H:","respuesta":"HPALABRA","pista":"pista"}]} 8 letras REALES sobre el tema.`,
      ruleta: `Genera ruleta sobre "${tema}" ${area} grado ${grado} Colombia. SOLO JSON: {"categorias":[{"nombre":"Facil","color":"#22c55e","preguntas":[{"pregunta":"Pregunta 1","respuesta":"R1"},{"pregunta":"P2","respuesta":"R2"}]},{"nombre":"Medio","color":"#f59e0b","preguntas":[{"pregunta":"P1","respuesta":"R1"}]},{"nombre":"Dificil","color":"#ef4444","preguntas":[{"pregunta":"P1","respuesta":"R1"}]},{"nombre":"Comodin","color":"#8b5cf6","preguntas":[{"pregunta":"P1","respuesta":"R1"}]}]} Preguntas REALES.`,
      memoria: `Genera memoria sobre "${tema}" ${area} grado ${grado} Colombia. SOLO JSON: {"pares":[{"id":1,"termino":"T1","definicion":"D1"},{"id":2,"termino":"T2","definicion":"D2"},{"id":3,"termino":"T3","definicion":"D3"},{"id":4,"termino":"T4","definicion":"D4"},{"id":5,"termino":"T5","definicion":"D5"},{"id":6,"termino":"T6","definicion":"D6"}]} 6 pares REALES.`,
